...
@section('content')
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
        <form action="{{ route('tracking.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $item->nasabah->user->username }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            ...
                            @else
                                <a href="{{ route('tracking.show', ['search' => $item->nasabah->nik_ktp]) }}" 
                    ...
                    <x-modal name="confirm-printing-{{ $item->id }}" focusable maxWidth="sm">
                        <div class="p-6">
                            ...
                            <form method="POST" action="{{ route('funding.updateStatus', $item->id) }}"> 
                                @csrf
