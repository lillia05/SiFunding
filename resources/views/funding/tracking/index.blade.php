...
@section('content')
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap align-middle">
                            ...
                            <span class="text-xs text-yellow-600 font-medium mt-1 block">Menunggu Cetak</span>
                        </td>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <button 
                                ...
                                class="text-white hover:bg-teal-700 bg-bsi-teal px-4 py-1.5 rounded-full text-xs font-bold shadow-sm transition transform hover:-translate-y-0.5">
                                Serahkan
                            </button>
                        </td>
                    </tr>
    ...
    <x-modal name="confirm-printing" focusable maxWidth="sm">
        <div class="p-6">
            ...
            <p class="text-center text-gray-500 text-sm mb-6 leading-relaxed">
                Ubah status menjadi <b>Siap Diserahkan</b>?<br>
                Pastikan buku tabungan fisik sudah selesai dicetak.
            </p>
